    ...
    public partial class ODataSerializerContext
    {
        ...
        internal bool IsDeltaOfT
        {
            get
            {
                if (_isDeltaOfT == null)
                {
                    _isDeltaOfT = Type != null && TypeHelper.IsGenericType(Type) && (Type.GetGenericTypeDefinition() == typeof(Delta<>) || 
                        Type.GetGenericTypeDefinition() == typeof(DeltaSet<>) || Type.GetGenericTypeDefinition() == typeof(DeltaDeletedEntityObject<>));
                }
        ...
        internal IEdmTypeReference GetEdmType(object instance, Type type)
        {
            ...
            else
            {
                ...
                if (edmType == null)
                {
                    if (instance != null)
                    {
                        if (instance is TypedDelta delta)
                        {
