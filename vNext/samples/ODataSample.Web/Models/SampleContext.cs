...
namespace ODataSample.Web.Models
{
	...
	public class SampleContext : ISampleService
	{
		...
		private readonly List<Customer> _customers = new List<Customer>
		  {
				new Customer { CustomerId = 1, FirstName = "Cust1First", LastName = "Cust1Last" },
				new Customer { CustomerId = 2, FirstName = "Cust2First", LastName = "Cust2Last" },
				new Customer { CustomerId = 3, FirstName = "Cust3First", LastName = "Cust3Last" },
				new Customer { CustomerId = 4, FirstName = "Cust4First", LastName = "Cust4Last" },
				new Customer { CustomerId = 5, FirstName = "Cust5First", LastName = "Cust5Last" }
		  };
