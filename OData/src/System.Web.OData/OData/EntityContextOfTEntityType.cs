...
{
    /// <summary>
    /// An instance of <see cref="EntityContext{TEntityType}"/> gets passed to the self link (<see cref="M:EntitySetConfiguration.HasIdLink"/>, <see cref="M:EntitySetConfiguration.HasEditLink"/>, <see cref="M:EntitySetConfiguration.HasReadLink"/>)
    ...
    public class EntityContext<TEntityType> : EntityContext
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityContext{TEntityType}"/> class.
        /// </summary>
