...
namespace WebStack.QA.Test.OData.QueryComposition.Fuzzing
{
    public class QueryBuilder
    {
        ...
        public static Syntax CreateFilterQuerySyntax()
        {
            ...
            var datetimeLiteralExpr = new Literal("datetime'2012-09-11T00:08:00'");
            ...
            var memberPrefixPathExpr = Literal.Empty
                ...
                //| new Literal("MultipleNavigationProperty(123)/")
                //| new Literal("MultipleNavigationProperty(123)/SingleNavigationProperty/");

            var boolMemberExpr = memberPrefixPathExpr + new Literal("BoolProperty");
            var stringMemberExpr = memberPrefixPathExpr + (new Literal("StringProperty")); //| new Literal("CharArrayProperty"));
            var dateTimeMemberExpr = memberPrefixPathExpr + new Literal("DateTimeProperty");
            var nullableMemberExpr =
                (memberPrefixPathExpr + (
                    new Literal("StringProperty")
                    | new Literal("DateTimeProperty")
                    | new Literal("DecimalProperty")));
                //| (new Literal("ComplexTypeProperty")
                //    | new Literal("SingleNavigationProperty")
                //    | new Literal("MultipleNavigationProperty")
                //    | new Literal("StringCollectionProperty")
                //    | new Literal("ComplextTypeCollectionProperty"));
            ...
            var int32MemberExpr = memberPrefixPathExpr +
                ...
                //| new Literal("UInt16Property")
                //| new Literal("UInt32Property")
                //| new Literal("Int32Property")
                //| new Literal("UInt64Property"));
            ...
            var dateTimeCommonExpr = datetimeLiteralExpr | dateTimeMemberExpr;
        ...
        public static Syntax CreateODataQuerySyntax()
        {
            ...
            var primitiveColumns = new Literal("StringProperty") | "DateTimeProperty" | "DecimalProperty" | "LongProperty" | "BoolProperty" | "GuidProperty" | "Int32Property";
