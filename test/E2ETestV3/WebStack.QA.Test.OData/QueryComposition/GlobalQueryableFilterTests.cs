...
namespace WebStack.QA.Test.OData.QueryComposition
{
    ...
    {
        public DerivedODataQueryOptions(ODataQueryContext context, HttpRequestMessage request) : base(context, request)
        {
        }
    }
    ...
    public class DerivedEnitySetController : EntitySetController<Product, int>
    {
        [DerivedQueryable]
    ...
    public class GlobalQueryableFilterWithDerivedQueryableAttribute : ODataTestBase
    {
        [NuwaConfiguration]
        public static void UpdateConfiguration(HttpConfiguration configuration)
        {
