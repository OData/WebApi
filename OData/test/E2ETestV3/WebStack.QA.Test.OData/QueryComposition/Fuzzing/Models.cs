...
namespace WebStack.QA.Test.OData.QueryComposition.Fuzzing
{
    public class FuzzingContext : DbContext
    {
        public FuzzingContext()
            : base("FuzzingContext")
        {
            //Database.SetInitializer(new FuzzingDataInitializer());
        ...
        public static List<EntityTypeModel1> Generate()
        {
            ...
            for (int i = 0; i < 10000; i++)
            {
                var complex1 = new ComplexTypeModel1()
                {
                    ...
                    DateTimeProperty = new DateTime(2012, 9, 11, 0, 8, 0),
                ...
                var entity1 = new EntityTypeModel1()
                {
                    ...
                    DoubleProperty = 100000.11,
                    FloatProperty = 992.1f,
                //    StringCollectionProperty = new string[]
                //{
                //    "stringLiternal",
                //    "stringLiternal"
                //},
                    ComplexTypeProperty = complex1,
                //    ComplextTypeCollectionProperty = new ComplexTypeModel1[] 
                //{
                //    complex1,
                //    complex1
                //},
                    SingleNavigationProperty = entity2,
                //    MultipleNavigationProperty = new EntityTypeModel2[] 
                //{
                //    entity2,
                //    entity2
                //}
    ...
    public class EntityTypeModel1
    {
        ...
        //public ICollection<EntityTypeModel2> MultipleNavigationProperty { get; set; }

        //public ICollection<string> StringCollectionProperty { get; set; }

        //public ICollection<ComplexTypeModel1> ComplextTypeCollectionProperty { get; set; }
    }
