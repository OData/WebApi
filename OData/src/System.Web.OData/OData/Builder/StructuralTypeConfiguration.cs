...
namespace System.Web.OData.Builder
{
    ...
    public abstract class StructuralTypeConfiguration : IEdmTypeConfiguration
    {
        ...
        public virtual PrimitivePropertyConfiguration AddProperty(PropertyInfo propertyInfo)
        {
            ...
            PrimitivePropertyConfiguration propertyConfiguration = AddExistExplicitProperty<PrimitivePropertyConfiguration>(propertyInfo, SRResources.MustBePrimitiveProperty);
        ...
        public virtual EnumPropertyConfiguration AddEnumProperty(PropertyInfo propertyInfo)
        {
            ...
            EnumPropertyConfiguration propertyConfiguration = AddExistExplicitProperty<EnumPropertyConfiguration>(propertyInfo, SRResources.MustBeEnumProperty);
            if (propertyConfiguration == null)
            {
        ...
        public virtual ComplexPropertyConfiguration AddComplexProperty(PropertyInfo propertyInfo)
        {
            ...
            ComplexPropertyConfiguration propertyConfiguration = AddExistExplicitProperty<ComplexPropertyConfiguration>(propertyInfo, SRResources.MustBeComplexProperty);
            if (propertyConfiguration == null)
            {
        ...
        public virtual CollectionPropertyConfiguration AddCollectionProperty(PropertyInfo propertyInfo)
        {
            ...
            CollectionPropertyConfiguration propertyConfiguration = AddExistExplicitProperty<CollectionPropertyConfiguration>(propertyInfo, SRResources.MustBeCollectionProperty);
            if (propertyConfiguration == null)
            {
        ...
        internal T AddExistExplicitProperty<T>(PropertyInfo propertyInfo, string typeErrorMessage) where T : class
        {
