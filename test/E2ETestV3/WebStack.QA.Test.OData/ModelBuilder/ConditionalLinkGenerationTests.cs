...
{
    public class ConditionalLinkGeneration_ProductsController : InMemoryEntitySetController<Product, int>
    {
    ...
    public class ConditionalLinkGeneration_SuppliersController : InMemoryEntitySetController<Supplier, int>
    {
    ...
    public class ConditionalLinkGeneration_ProductFamiliesController : InMemoryEntitySetController<ProductFamily, int>
    {
    ...
    public class ConditionalLinkGeneration_ConventionModelBuilder_Tests : ODataTestBase
    {
        ...
        private static Microsoft.Data.Edm.IEdmModel GetImplicitEdmModel()
        {
            ...
            products.HasReadLink(
                ctx =>
                {
                    ...
                    return ctx.Url.CreateODataLink(
