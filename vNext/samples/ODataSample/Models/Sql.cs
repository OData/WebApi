namespace ODataSample.Web.Models
{
	...
	{
		public const string DbName = "Microsoft.AspNetCore.OData.App.Data";

		public const string NewDb = @"-- GENERATED BY DatabaseCreator.cs
...
END
CREATE LOGIN [roadsteadsLogin] WITH PASSWORD=N'ypN{@:2e9rfJ3/E[].:fzY4%.', DEFAULT_DATABASE=[" + DbName + @"], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
...
END
/* END IF NO CREATE */
CREATE LOGIN [morselsLogin] WITH PASSWORD=N'PPm|Wb(An!Cb1~{}&]UPxO@nf', DEFAULT_DATABASE=[" + DbName + @"], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
