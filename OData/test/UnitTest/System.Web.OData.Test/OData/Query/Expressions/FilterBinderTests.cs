    ...
    public class FilterBinderTests
    {
        ...
        public void CustomMethod_InstanceMethodOfDeclaringType()
        {
            ...
            try
            {
                ...
                UriFunctionsToClrBinder.BindUriFunctionName(padrightMethodName, padRightStringMethodInfo);
            ...
            finally
            {
                ...
                Assert.True(UriFunctionsToClrBinder.UnbindUriFunctionName(padrightMethodName, padRightStringMethodInfo));
            }
        }
