...
namespace System.Web.Http.OData.Builder.Conventions.Attributes
{
    public class AttributeEdmTypeConventionOfTEdmTypeConfigurationTests
    {
        ...
        [InlineData(typeof(StructuralTypeConfiguration), typeof(IStructuralTypeConfiguration), true)]
        ...
        [InlineData(typeof(ComplexTypeConfiguration), typeof(IStructuralTypeConfiguration), true)]
        ...
        [InlineData(typeof(EntityTypeConfiguration), typeof(IStructuralTypeConfiguration), true)]
        ...
        public static bool Apply<TEdmTypeConfiguration, TConventionType>()
            ...
            where TConventionType : class, IStructuralTypeConfiguration
        {
            ...
            Mock<TEdmTypeConfiguration> structuralType = new Mock<TEdmTypeConfiguration>(MockBehavior.Strict, builder, type.Object);
