    ...
    public class ValidatorTests : ODataTestBase
    {
        public static TheoryDataSet<ODataValidationSettings, string, bool> ValidateOptionsData
        {
            get
            {
                ...
                set.Add(commonSettings, "$top=10&$orderby=ID,DateTime&$filter=substringof('Test', Name) and (DateTime gt datetime'2012-12-04' or 1 add 1 eq 2) and floor(Double) gt 5", true);
                set.Add(commonSettings, "$top=10&$orderby=ID,DateTime&$filter=substringof('Test', Name) and (DateTime gt datetime'2012-12-04' or 1 add 1 eq 2) and floor(Decimal) gt 5", true);
                set.Add(commonSettings, "$top=10&$orderby=ID,DateTime&$filter=substringof('Test', Name) and (DateTime gt datetime'2012-12-04' or 1 add 1 eq 2) and length(Name) gt 5", false);
        ...
        public static TheoryDataSet<AllowedFunctions, AllowedFunctions> AllowedFunctionsData
        {
            get
            {
                ...
                data.Add(AllowedFunctions.AllDateTimeFunctions, AllowedFunctions.Days);
                data.Add(AllowedFunctions.AllDateTimeFunctions, AllowedFunctions.Hour);
                data.Add(AllowedFunctions.AllDateTimeFunctions, AllowedFunctions.Hours);
                data.Add(AllowedFunctions.AllDateTimeFunctions, AllowedFunctions.Minute);
                data.Add(AllowedFunctions.AllDateTimeFunctions, AllowedFunctions.Minutes);
                data.Add(AllowedFunctions.AllDateTimeFunctions, AllowedFunctions.Month);
                data.Add(AllowedFunctions.AllDateTimeFunctions, AllowedFunctions.Months);
                data.Add(AllowedFunctions.AllDateTimeFunctions, AllowedFunctions.Second);
                data.Add(AllowedFunctions.AllDateTimeFunctions, AllowedFunctions.Seconds);
                data.Add(AllowedFunctions.AllDateTimeFunctions, AllowedFunctions.Year);
                data.Add(AllowedFunctions.AllDateTimeFunctions, AllowedFunctions.Years);
        ...
        [InlineData("/api/ValidatorTests/OnlySupportSubString?$filter=substringof('10', Name)", false)]
        [InlineData("/api/ValidatorTests/SupportAllFunctions?$filter=substringof('10', Name)", true)]
