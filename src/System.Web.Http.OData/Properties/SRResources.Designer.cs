...
namespace System.Web.Http.OData.Properties {
    ...
    internal class SRResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The dependent property types &apos;{0}&apos; are not same as the principal key types &apos;{1}&apos;. The dependent and principal must each contain the same number of elements and must have the same types..
        /// </summary>
        internal static string DependentPropertiesNotMatchWithPrincipalKeys {
            get {
                return ResourceManager.GetString("DependentPropertiesNotMatchWithPrincipalKeys", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Set referential constraint for a collection-valued navigation property &apos;{0}&apos; on type &apos;{1}&apos; is not supported. Only required or optional navigation property is supported..
        /// </summary>
