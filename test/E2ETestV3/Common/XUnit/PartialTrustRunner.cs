...
namespace WebStack.QA.Common.XUnitTest
{
    public class PartialTrustRunner : ITestClassCommand
    {
        ...
        public object ObjectUnderTest
        {
            get
            {
                return this.sandbox.CreateInstanceAndUnwrap(
                    this.TypeUnderTest.Type.Assembly.FullName, this.TypeUnderTest.Type.FullName);
            }
        }
        ...
        public static AppDomain CreatePartialTrustAppDomain()
        {
