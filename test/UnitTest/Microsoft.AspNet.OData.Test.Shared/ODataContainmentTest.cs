...
namespace Microsoft.Test.AspNet.OData
{
    public class ODataContainmentTest
    {
        ...
        public async Task GetSpecialOrderLines_Containment()
        {
            ...
            Assert.True(response.IsSuccessStatusCode);
            Assert.Contains(
                "http://localhost/odata/$metadata#MyOrders(1)/OrderLines/Microsoft.Test.AspNet.OData.Builder.TestModels.SpecialOrderLine",
        ...
        public async Task GetMyOrder_WithOrWithoutCastType_Containment(string url)
        {
            ...
            Assert.True(response.IsSuccessStatusCode);
            Assert.Contains(
                "http://localhost/odata/$metadata#MyOrders/Microsoft.Test.AspNet.OData.Builder.TestModels.MySpecialOrder/$entity",
                (string)result["@odata.context"]);
        }
        ...
        public async Task GetMyOrders_HasLinks_WithContainmentPropertiesAndJsonFullMetadata()
        {
            ...
            Assert.Equal("http://localhost/odata/MyOrders(2)/Microsoft.Test.AspNet.OData.Builder.TestModels.MySpecialOrder", mySpecialOrder["@odata.editLink"]);
            Assert.Equal("http://localhost/odata/MyOrders(2)/Microsoft.Test.AspNet.OData.Builder.TestModels.MySpecialOrder/OrderLines", mySpecialOrder["OrderLines@odata.navigationLink"]);
            Assert.Equal("http://localhost/odata/MyOrders(2)/Microsoft.Test.AspNet.OData.Builder.TestModels.MySpecialOrder/OrderLines/$ref", mySpecialOrder["OrderLines@odata.associationLink"]);
        }
        ...
        public async Task ExpandOrderLines_Containment_FullMetadata()
        {
            ...
            Assert.Equal("#Microsoft.Test.AspNet.OData.Builder.TestModels.SpecialOrderLine", orderLine["@odata.type"]);
            Assert.Equal("MyOrders(1)/OrderLines(22)", orderLine["@odata.id"]);
            Assert.Equal(
                "MyOrders(1)/OrderLines(22)/Microsoft.Test.AspNet.OData.Builder.TestModels.SpecialOrderLine",
                orderLine["@odata.editLink"]);
            tag = orderLine["#ns.Tag"];
            Assert.Equal("ns.Tag", tag["title"]);
            Assert.Equal(
                "http://localhost/odata/MyOrders(1)/OrderLines(22)/Microsoft.Test.AspNet.OData.Builder.TestModels.OrderLine/ns.Tag",
                tag["target"]);
        }
        ...
        public class MyOrdersController : ODataController
        {
            ...
            [EnableQuery]
            [ODataRoute("MyOrders({orderId})/Microsoft.Test.AspNet.OData.Builder.TestModels.MySpecialOrder")]
            ...
            [ODataRoute("MyOrders({orderId})/OrderLines/Microsoft.Test.AspNet.OData.Builder.TestModels.SpecialOrderLine")]
