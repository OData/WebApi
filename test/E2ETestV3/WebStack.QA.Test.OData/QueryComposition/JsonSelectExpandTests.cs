...
namespace WebStack.QA.Test.OData.QueryComposition
{
    public class JsonSelectExpandTests : ODataTestBase
    {
        ...
        {
            string queryUrl = string.Format("{0}/api/JsonSelectCustomer/?$select=Id,Name,JsonSelectOrders/Id&$expand=JsonSelectOrders", BaseAddress);
            HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Get, queryUrl);
            request.Headers.Accept.Add(MediaTypeWithQualityHeaderValue.Parse("application/json"));
            HttpClient client = new HttpClient();
            HttpResponseMessage response;
        ...
        {
            string queryUrl = string.Format("{0}/api/JsonSelectCustomer/PremiumCustomers?$select=Id,WebStack.QA.Test.OData.QueryComposition.JsonSelectPremiumCustomer/Category", BaseAddress);
        ...
        {
            string queryUrl = string.Format("{0}/api/JsonSelectCustomer?$select=Id,JsonSelectOrders&$expand=JsonSelectOrders", BaseAddress);
            HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Get, queryUrl);
            request.Headers.Accept.Add(MediaTypeWithQualityHeaderValue.Parse("application/json"));
            HttpClient client = new HttpClient();
            HttpResponseMessage response;
            ...
            Assert.True(result.OfType<JObject>().All(x => x.Properties().Count() == 2));
            foreach (JObject customer in result)
            {
        ...
        {
            string queryUrl = string.Format("{0}/api/JsonSelectCustomer/PremiumCustomers?$select=Id,JsonSelectOrders,WebStack.QA.Test.OData.QueryComposition.JsonSelectPremiumCustomer/Bonuses&$expand=JsonSelectOrders,WebStack.QA.Test.OData.QueryComposition.JsonSelectPremiumCustomer/Bonuses", BaseAddress);
            HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, queryUrl);
            request.Headers.Accept.Add(MediaTypeWithQualityHeaderValue.Parse("application/json"));
            HttpClient client = new HttpClient();
            HttpResponseMessage response;
        ...
        {
            string queryUrl = string.Format("{0}/api/JsonSelectCustomer?$select=Id,JsonSelectOrders,JsonSelectOrders/OrderDetails&$expand=JsonSelectOrders/OrderDetails", BaseAddress);
            HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Get, queryUrl);
            request.Headers.Accept.Add(MediaTypeWithQualityHeaderValue.Parse("application/json"));
            HttpClient client = new HttpClient();
            HttpResponseMessage response;
        ...
        {
            string queryUrl = string.Format("{0}/api/JsonSelectCustomer/PremiumCustomers?$select=Id,WebStack.QA.Test.OData.QueryComposition.JsonSelectPremiumCustomer/Bonuses&$expand=WebStack.QA.Test.OData.QueryComposition.JsonSelectPremiumCustomer/Bonuses", BaseAddress);
            HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, queryUrl);
            request.Headers.Accept.Add(MediaTypeWithQualityHeaderValue.Parse("application/json"));
            HttpClient client = new HttpClient();
            HttpResponseMessage response;
