...
namespace System.Web.OData.Query.Expressions
{
    public class FilterBinderTests
    {
        ...
        public void DateTimeOffsetInEqualities(string clause, string expectedExpression)
        {
            ...
            Assert.Throws<ODataException>(() => Bind("" + clause), allowDerivedExceptions: true);
        ...
        {
            // Arrange & Act & Assert
            Assert.Throws<ODataException>(() => Bind<DataTypes>(filter), errorMessage, allowDerivedExceptions: true);
        }
