...
END
/* CREATE */ CREATE LOGIN [antiphonalLogin] WITH PASSWORD=N'L~a]<FgjVg9>QlGO18Bp9a^^O', DEFAULT_DATABASE=[OData.Legacy.App.Data], CHECK_EXPIRATION=OFF, CHECK_POLICY=OFF
