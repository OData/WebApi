...
namespace System.Web.WebPages.Test
{
    public class WebPageRouteTest
    {
        ...
        private static void ConstraintTest(IEnumerable<string> validFiles, IEnumerable<string> supportedExt, string url, string match, string pathInfo, bool mobileDevice = false)
        {
            ...
            WebPageMatch smartyMatch = WebPageRoute.MatchRequest(url, supportedExt.ToList(), objectFactory, mockContext.Object, displayModeProvider);
            if (match != null)
            {
        ...
        public void MatchRequestSetsDisplayModeOfFirstMatchPerContext()
        {
            ...
            // Act
            WebPageMatch mobileMatch = WebPageRoute.MatchRequest("page.aspx", new List<string>() { "aspx" }, objectFactory, mockContext.Object, displayModeProvider);
        ...
        public void MatchRequestDoesNotSetDisplayModeIfNoMatch()
        {
            ...
            // Act
            WebPageMatch smartyMatch = WebPageRoute.MatchRequest("notThere.aspx", new List<string>() { "aspx" }, objectFactory, mockContext.Object, displayModeProvider);
