...
namespace WebStack.QA.Test.OData.ETags
{
    ...
    public class DerivedETagTests
    {
        ...
        public void DerivedTypesHaveSameETagsTest()
        {
            ...
            var jsonETags1 = jsonResult.GetValue("value").Select(e => e["@odata.etag"].ToString());
            ...
            Assert.True(String.Concat(jsonETags1) == String.Concat(derivedEtags), "Derived Types has different etags than base type");
            ...
            Assert.True(jsonETags1.FirstOrDefault() == singletonEtag, "Singleton has different etags than set");
        }
    }
}
