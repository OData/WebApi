...
namespace Microsoft.AspNet.OData
{
    ...
    {
        internal static Uri GetNextPageLink(Uri requestUri, IEnumerable<KeyValuePair<string, string>> queryParameters, int pageSize, object instance = null, Func<object, string> objectToSkipTokenValue = null, ODataCompatibilityOptions options = ODataCompatibilityOptions.None)
        {
                ...
                switch (key)
                {
                    case "$top":
                        ...
                        if (Int32.TryParse(value, out top))
                        {
                            ...
                            if ((options & ODataCompatibilityOptions.AllowNextLinkWithNonPositiveTopValue) != 0 || top > pageSize)
                            {
