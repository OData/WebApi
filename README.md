## OData Web API
<img src="https://identitydivision.visualstudio.com/_apis/public/build/definitions/2cfe7ec3-b94f-4ab9-85ab-2ebff928f3fd/104/badge"/>
...
### Nightly builds
The nightly build process will upload a NuGet packages for WebApi to the [MyGet.org webapinightly-maintenancev4 feed](https://www.myget.org/gallery/webapinightly-maintenancev4).

To connect to webapinightly-maintenancev4 feed, use this feed URL: [webapinightly-maintenancev4 MyGet feed URL](https://www.myget.org/F/webapinightly-maintenancev4).

You can query the latest nightly NuGet packages using this query: [MAGIC WebApi query](https://www.myget.org/F/webapinightly-maintenancev4/Packages?$select=Id,Version&$orderby=Version%20desc&$top=4&$format=application/json)
