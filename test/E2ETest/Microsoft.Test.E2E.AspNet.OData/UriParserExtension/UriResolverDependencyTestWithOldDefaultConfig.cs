...
{
    public class UnqualifiedCallTestWithOldDefaultConfig : WebHostTestBase<UnqualifiedCallTestWithOldDefaultConfig>
    {
        public UnqualifiedCallTestWithOldDefaultConfig(WebHostTestFixture<UnqualifiedCallTestWithOldDefaultConfig> fixture)
            : base(fixture)
        {
        }
