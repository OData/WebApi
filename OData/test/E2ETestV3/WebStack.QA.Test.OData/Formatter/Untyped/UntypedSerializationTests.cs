...
namespace WebStack.QA.Test.OData.Formatter.Untyped
{
    ...
    public class UntypedSerializationTests
    {
        ...
        public static void UpdateConfiguration(HttpConfiguration configuration)
        {
            ...
            configuration.Routes.MapODataServiceRoute("untyped", "untyped", GetEdmModel());
        }
        ...
        {
            string url = "/untyped/UntypedCustomers/" + actionName;
        ...
        public void RoundTripEntityWorks()
        {
            ...
            getRequest.Headers.Accept.Add(MediaTypeWithQualityHeaderValue.Parse("application/json;odata=nometadata"));
        ...
        {
            HttpRequestMessage request = new HttpRequestMessage(HttpMethod.Post, BaseAddress + "/untyped/UntypedCustomers/UntypedParameters");
