//-----------------------------------------------------------------------------
// <copyright file="NestedPathsRoutingConvention.cs" company=".NET Foundation">
...
{
    /// <summary>
    /// An implementation of <see cref="IODataRoutingConvention"/> that handles GET requests with arbitrarily nested paths.
    /// </summary>
