...
namespace Microsoft.Test.E2E.AspNet.OData.BulkInsert1
{
    public class BulkInsertTest : WebHostTestBase
    {
        ...
        [Fact]
        public async Task PatchToEnumCollection()
        {
            //Arrange
            await ResetDatasource();
            string requestUri = this.BaseAddress + "/convention/Employees/2/SkillSet?$format=application/json;odata.metadata=none";
            ...
            //Set up the post request
            requestUri = this.BaseAddress + "/convention/Employees/2/FavoriteSports?$format=application/json;odata.metadata=none";
        ...
        [Fact]
        public async Task PatchEmployees()
        {
            //Arrange
            await ResetDatasource();
            string requestUri = this.BaseAddress + "/convention/Employees?$format=application/json;odata.metadata=none";
