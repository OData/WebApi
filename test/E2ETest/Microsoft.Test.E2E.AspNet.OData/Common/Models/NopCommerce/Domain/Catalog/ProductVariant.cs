//-----------------------------------------------------------------------------
// <copyright file="ProductVariant.cs" company=".NET Foundation">
...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class ProductVariant : BaseEntity, ILocalizedEntity
    {
        ...
        /// </summary>
        public virtual DateTimeOffset? SpecialPriceStartDateTimeUtc { get; set; }

        /// <summary>
        /// Gets or sets the end date and time of the special price
        /// </summary>
        public virtual DateTimeOffset? SpecialPriceEndDateTimeUtc { get; set; }
        ...
        /// </summary>
        public virtual DateTimeOffset? AvailableStartDateTimeUtc { get; set; }

        /// <summary>
        /// Gets or sets the available end date and time
        /// </summary>
        public virtual DateTimeOffset? AvailableEndDateTimeUtc { get; set; }
