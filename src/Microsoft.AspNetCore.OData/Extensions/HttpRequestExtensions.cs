...
namespace Microsoft.AspNet.OData.Extensions
{
    ...
    public static class HttpRequestExtensions
    {
        ...
        public static Uri GetNextPageLink(this HttpRequest request, int pageSize)
        {
            ...
            UriBuilder uriBuilder = new UriBuilder(request.Scheme, request.Host.Host, request.Host.Port.HasValue ?
                request.Host.Port.Value : 80, (request.PathBase + request.Path).ToUriComponent());
