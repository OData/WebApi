        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavouriteProductId = table.Column<int>(nullable: true),
                    ...
                    UsedProductId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateCreated = table.Column<DateTimeOffset>(nullable: false, defaultValueSql: "getdate()"),
                    DateInvented = table.Column<DateTimeOffset>(nullable: false),
                    Guid = table.Column<Guid>(nullable: true),
                    LastModifiedByUserId = table.Column<string>(nullable: true),
                    Name = table.Column<string>(nullable: false),
                    OwnerEmailAddress = table.Column<string>(nullable: false),
                    Price = table.Column<double>(nullable: false),
                    SomeSecretFieldThatShouldNotBeReturned = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
