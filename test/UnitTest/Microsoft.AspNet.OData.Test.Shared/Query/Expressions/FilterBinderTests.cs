...
namespace Microsoft.AspNet.OData.Test.Query.Expressions
{
    ...
    public class FilterBinderTests
    {
        ...
        [InlineData("cast(Microsoft.AspNet.OData.Test.Common.Types.SimpleEnum'1',Edm.String) eq '1'", "$it => (Convert(Second).ToString() == \"1\")")]
        ...
        [InlineData("CharProp eq 'a'", "$it => ($it.CharProp.ToString() == \"a\")")]
