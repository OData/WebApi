...
namespace System.Web.OData
{
    public class ODataUriResolverExtensionTest
    {
        ...
        [InlineData("gender='Male'", false, HttpStatusCode.OK)] //ODL 7.4
        ...
        [InlineData("gender='SomeUnknowValue'", true, HttpStatusCode.BadRequest)] //ODL 7.4
        ...
        [InlineData("$filter=Gender eq 'Male'", false, HttpStatusCode.OK, "0,2,4,6,8")] //ODL 7.4
        [InlineData("$filter=Gender eq 'Female'", true, HttpStatusCode.OK, "1,3,5,7,9")]
        [InlineData("$filter=Gender eq 'Female'", false, HttpStatusCode.OK, "1,3,5,7,9")] //ODL 7.4
        ...
        //[InlineData("$filter=Gender eq 'SomeUnknowValue'", true, HttpStatusCode.BadRequest, null)] // ODL 7.4.
