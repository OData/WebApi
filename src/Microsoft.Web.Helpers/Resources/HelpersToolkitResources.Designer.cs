...
namespace Resources {
    ...
    internal class HelpersToolkitResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Google Buzz is no longer supported by the Link Share helper. It will be removed entirely in the next major version..
        /// </summary>
        internal static string GoogleBuzz_NotSupported {
            get {
                return ResourceManager.GetString("GoogleBuzz_NotSupported", resourceCulture);
            }
        }
