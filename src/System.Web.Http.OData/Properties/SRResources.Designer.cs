...
namespace System.Web.Http.OData.Properties {
    ...
    internal class SRResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Arithmetic operator &apos;{0}&apos; is not allowed. To allow it, try setting the &apos;{1}&apos; property on QueryableAttribute or QueryValidationSettings..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Function &apos;{0}&apos; is not allowed. To allow it, try setting the &apos;{1}&apos; property on QueryableAttribute or QueryValidationSettings..
        /// </summary>
        internal static string NotAllowedFunctionName {
            get {
                return ResourceManager.GetString("NotAllowedFunctionName", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Logical operator &apos;{0}&apos; is not allowed. To allow it, try setting the &apos;{1}&apos; property on QueryableAttribute or QueryValidationSettings..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Order by &apos;{0}&apos; is not allowed. To allow it, try setting the &apos;{1}&apos; property on QueryableAttribute or QueryValidationSettings..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Query option &apos;{0}&apos; is not allowed. To allow it, try setting the &apos;{1}&apos; property on QueryableAttribute or QueryValidationSettings..
        /// </summary>
